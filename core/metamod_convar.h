#ifndef METAMOD_CONVAR_H
#define METAMOD_CONVAR_H
...
template<typename T>
class MetamodSourceConVar // Hier beginnt die eigentliche Deklaration der Klasse
{
private:
...
// Basisklasse für MetamodSourceConVar
class MetamodSourceConVarBase {
public:
    MetamodSourceConVarBase(const char* name, int flags, const char* help) 
        : m_name(name), m_flags(flags), m_help(help) {}
    
    virtual ~MetamodSourceConVarBase() {}
...
// Vorwärtsdeklaration der Klasse MetamodSourceConVar
template<typename T>
class MetamodSourceConVar;

// Definition der Variablen
extern MetamodSourceConVar<const char*> metamod_version;
extern MetamodSourceConVar<const char*> mm_pluginsfile;
extern MetamodSourceConVar<const char*> mm_basedir;

#include "metamod_convar.hxx"

#endif // METAMOD_CONVAR_H